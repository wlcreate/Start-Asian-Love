...
export default function Wins() {
  ...
  return (
    ...
    <Header/>
      ...
      <button onClick={gotoHeritage} className={styles.scroll}>Heritage</button>
      <button onClick={gotoContributions} className={styles.scroll}>Contributions</button>
      <button onClick={gotoRepresentation} className={styles.scroll}>Representation</button>
      <button onClick={gotoArt} className={styles.scroll}>Art</button>
