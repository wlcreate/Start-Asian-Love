  ...
  return (
    <div>
      <Head>
        ...
        <Header/>
        {/* <Carousel/> */}
        <Image className={styles.hero} src="/Hero.jpg" alt="Start Asian Love Hero" loading="lazy" width={1920} height={1200} layout="responsive"/>
        ...
        <div className={styles.content}>
          ...
          <div className={styles.factcontainer}>
            <div className={styles.facts}>
              ...
              <p> Unfortunately, it’s not all. The group notes in their report that this number represents “only a fraction of the number of hate incidents that actually occur”, with the <a href="https://stopaapihate.org/2020-2021-national-report/" target="_blank" rel="noopener noreferrer">
                  full report
                </a> showing “how vulnerable Asian Americans are to discrimination, and the types of discrimination they face”.
              </p>
            </div>
            ...
            <div className={styles.facts}>
              ...
              <p>
                ...
                <p>The <a href="https://www.csusb.edu/sites/default/files/FACT%20SHEET-%20Anti-Asian%20Hate%202020%203.2.21.pdf" target="_blank" rel="noopener noreferrer">
                  report
                </a> also pinpoints the first spike “occurring in March and April amidst a rise in COVID cases and negative stereotyping of Asians relating to the pandemic”. This increase happened while overall hate crimes dropped by 7%.
              </p>
            </div>
          </div>
          ...
          <div className={styles.graphicRowOne}>
            ...
            <div className={styles.graphic}><Image src="/Graphics/graphic03.jpg" alt="" loading="lazy" width={374} height={374} layout="responsive"/></div>
            <div className={styles.graphic}><Image src="/Graphics/graphic08.jpg" alt="" loading="lazy" width={374} height={374} layout="responsive"/></div>
          </div>
          ...
          <div className={styles.graphicRowTwo}>
            ...
            <div className={styles.graphic}><Image src="/Graphics/graphic09.jpg" alt="" loading="lazy" width={374} height={374} layout="responsive"/></div>
            <div className={styles.graphic}><Image src="/Graphics/graphic11.jpg" alt="" loading="lazy" width={374} height={374} layout="responsive"/></div>
          </div>
